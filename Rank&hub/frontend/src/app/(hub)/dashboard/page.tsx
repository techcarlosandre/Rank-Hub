  ...
  const fetchRankingsData = async () => {
    ...
    try {
      ...
      if (!Array.isArray(rankings)) {
        console.warn("API de rankings não retornou uma lista:", rankings);
        setMyRankings([]);
        setLoading(false);
        return;
      }
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4 mt-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-xl font-black text-white italic" style={{ color: themeColor }}>{myStatus?.pontos || 0} PTS</p>
                            </div>
                          </div>
                        </div>
